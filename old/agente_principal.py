    ...
    system_text = (
        ...
        **Flujo de Trabajo Obligatorio (Priorizado)**
        ...
        3.  **Escalamiento Obligatorio (Creación de Tickets):**
            - Antes de escalar y generar el ticket, debe estar completamente seguro de la problematica del usuario, no conclusiones vagas, muy abiertas o poco especificas.
